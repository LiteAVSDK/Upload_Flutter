...
- (NSDictionary *)getStatusInfoV2 {
    ...
    [info setObject:[NSNumber numberWithInt:self.reportInfo.vodErrCode] forKey:@"vodErrCode"];
    [info setObject:self.reportInfo.cosErrCode forKey:@"cosErrCode"];
    [info setObject:self.reportInfo.vodSessionKey forKey:@"cosRegion"];
    [info setObject:[NSNumber numberWithInt:self.reportInfo.useCosAcc] forKey:@"useCosAcc"];
    [info setObject:[NSNumber numberWithInt:self.reportInfo.useHttpDNS] forKey:@"useHttpDNS"];
    [info setObject:[NSNumber numberWithLongLong:self.reportInfo.tcpConnTimeCost] forKey:@"tcpConnTimeCost"];
    [info setObject:[NSNumber numberWithLongLong:self.reportInfo.recvRespTimeCost] forKey:@"recvRespTimeCost"];
